...
// app's "分享" button (xhslink.com/xxxxx, no "www." — e.g.
// http://xhslink.com/abc123). Short links 302-redirect to the canonical
// URL, which Playwright follows automatically when rendering.
//
// Parsed via the URL API (rather than a substring/regex check on the raw
// string) so a malicious host like "xiaohongshu.com.evil.com" or
// "evil.com/xiaohongshu.com" can't be spoofed into passing validation —
// only the actual hostname (or a subdomain of it) is checked.
